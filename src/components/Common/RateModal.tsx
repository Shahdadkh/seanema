            ...
            <div className="inline-block align-bottom backgroundColor3 w-4/6 rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full">
              <div className="my-16">
                <Star1
                  ...
                  className="mx-auto"
                />
                <div className="text-white text-3xl font-bold text-center mt-4">
                  Seanema Pro
                </div>
              </div>
              <div className="backgroundColor1 border borderColor4">
                <div className="my-7">
                  <div className="textColor1 text-2xl font-semibold text-center px-5">
                    <div className="flex justify-center items-center my-4">
                      <Star1
                        size="20"
                        className="textColor1 mx-2"
                        variant="Outline"
                      />
                      <Star1
                        size="20"
                    ...
                    The name and photo on your profile will appearn with your
                    reviews
                  </div>
                  <div
